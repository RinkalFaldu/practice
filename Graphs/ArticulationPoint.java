...
// if removing it (and edges through it)
// increases the connected components of graph.
// Tarjan's Algorithm
// A node A that was discovered before curr node in the DFS,  is the ancestor of curr
// 3 cases to check for articulation point
// parent == -1 && disconnected children > 1 
// from u to v only one edge dt[u] < low[v]
// u starting point of cycle dt[u] = low[v]
